                    ...
                    <div class="card-body shadow">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('location') is-invalid @enderror"
                                name="location" id="location" value="{{ $plan->location }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('max_participant') is-invalid @enderror"
                                name="max_participant" id="max_participant" value="{{ $plan->max_participant }}"
                                placeholder="30">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('start_date') is-invalid @enderror"
                                name="start_date" id="start_date" value="{{ $plan->start_date }}">
                            @error('start_date')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('end_date') is-invalid @enderror"
                                name="end_date" id="end_date" value="{{ $plan->end_date }}">
                            @error('end_date')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
