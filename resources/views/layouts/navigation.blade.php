<nav x-data="{ open: false }" class="bg-cyan-950 border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        ...
                        <img src="{{ asset('img/logo.png') }}" class="w-[70px]" alt="">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('tambah-plan')" :active="request()->routeIs('tambah-plan')">
                        {{ __('Tambah Plan') }}
                    </x-nav-link>
                </div>
            </div>
